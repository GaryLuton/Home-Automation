...
metadata {
	...
	tiles(scale: 2){
		...
		valueTile("outsidetemperature", "device.outsidetemperature", width: 2, height: 2, decoration: "flat") {
		...
		standardTile("setAuto", "device.thermostat", width: 2, height: 2, decoration: "flat") {
        ...
        standardTile("setDry", "device.thermostat", width: 2, height: 2, decoration: "flat") {
        ...
        standardTile("setOn", "device.thermostat", width: 2, height: 2, decoration: "flat") {
        ...
        standardTile("setOff", "device.thermostat", width: 2, height: 2, decoration: "flat") {
        ...
        standardTile("cool", "device.thermostat", width: 2, height: 2, decoration: "flat") {
       ...
       standardTile("heat", "device.thermostat", width: 2, height: 2, decoration: "flat") {
        ...
        standardTile("fan", "device.thermostat", width: 2, height: 2, decoration: "flat") {
		...
		standardTile("SetFanSpeedAuto", "device.tadoFanSpeed", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true, decoration: "flat") {
        ...
        standardTile("SetFanSpeedHigh", "device.tadoFanSpeed", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true, decoration: "flat") {
        ...
        standardTile("SetFanSpeedMid", "device.tadoFanSpeed", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true, decoration: "flat") {
        ...
        standardTile("SetFanSpeedLow", "device.tadoFanSpeed", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true, decoration: "flat") {
		...
		/** standardTile("endManualControl", "device.thermostat", width: 2, height: 2, canChangeIcon: false, canChangeBackground: true, decoration: "flat") {
		...
		main(["thermostat"])
		details(["thermostat","coolingSetpointUp","coolingSetpointDown","autoOperation","outsidetemperature","tadoMode","refresh","tadoFanSpeed","setOn","setOff","fan","cool","SetFanSpeedAuto","endManualControl","SetFanSpeedLow","SetFanSpeedMid","SetFanSpeedHigh"])
	}
}
